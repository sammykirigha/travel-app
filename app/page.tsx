...
export default function Home() {
  ...
  return (
    <main className="">
      <div className="bg-[url('../public/beach-two.jpg')] opacity-90 relative  bg-cover bg-no-repeat h-screen">
        <Navbar />
        ...
        <div className="flex flex-col absolute left-0 top-[55%] mx-10 max-w-lg bg-transparent/10 p-2 rounded-lg ">
          ...
          <button className=" px-10 py-4 font-bold bg-[#ff5722] text-white text-[20px] leading-4 outline outline-2 outline-[#ff5722] mt-10 mb-2 w-fit rounded-lg">Book a Tour</button>
        </div>
        <div className=" absolute top-[50%] right-0 w-[700px]">
          <div className=" mx-2">
            <HomeCarousel />
          </div>
        </div>
